...
from keras.layers import Dense,Input,merge,Flatten,Dropout,LSTM,Add,Activation
...
def get_cnn_model(params):   
    ...
    modelStruct = Dense(params.cnn_last_layer_length, name='fc1')(modelStruct)
    modelStruct = Activation('elu')(modelStruct)
    modelStruct = Dropout(0.6)(modelStruct)
    modelStruct = Dense(params.cnn_last_layer_length, name='fc2')(modelStruct)
    modelStruct = Activation('elu')(modelStruct)
    modelStruct = Dropout(0.8)(modelStruct)
